...
The AI-ready household consumption anomaly detection dataset generated by this project is publicly available on Zenodo:

**Zenodo DOI:** https://doi.org/10.5281/zenodo.22857168

The dataset contains 167,811,461 valid smart-meter observations from 5,561 households at 30-minute resolution and is provided in Apache Parquet format for direct use in anomaly-detection experiments.

### Energy Demand Forecasting

The AI-ready aggregated energy demand forecasting dataset generated by this project is publicly available on Zenodo:

**Zenodo DOI:** https://doi.org/10.5281/zenodo.22858328

The dataset contains 19,862 hourly records and is provided in Apache Parquet format for direct use in 24-hour-ahead aggregated energy-demand forecasting.
